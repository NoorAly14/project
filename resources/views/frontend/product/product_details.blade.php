...
@endsection
    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="shop-grid-right.html">{{$product['cat']['category_name']}}</a> <span></span> {{$product['subcategoty']['subcategory_name']}}
     ...
     <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
         <div class="detail-gallery">
                ...
                <div class="product-image-slider">
                    ...
                    <img src="{{ asset($items->photo_name) }}" alt="product image" />
                    </figure>
                    @endforeach
                ...
                @foreach ($multi as $items)
                <div><img src="{{ asset($items->photo_name) }}" alt="product image" /></div>
                @endforeach
                </div>
         </div>
                <!-- End Gallery -->
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="detail-info pr-30 pl-30">
            ...
            @php
            $disscount = ($product->discount_price /$product->selling_price ) * 100 ;
            @endphp
            
            <div class="clearfix product-price-cover">
                @if ($product->discount_price ==  NULL) 
                <div class="product-price primary-color float-left">
                <span class="current-price text-brand"  >{{$product->selling_price}} EGP</span>
                </div>
                @else
                <div class="product-price primary-color float-left">
                    <span class="current-price text-brand">{{$product->selling_price - $product->discount_price}} EGP</span>
                    <span>
                        <span class="save-price font-md color3 ml-15">{{ round($disscount)}} % Dis</span>
                        <span class="old-price font-md ml-15">{{$product->selling_price}} EGP</span>
                    </span>
                </div>
                @endif
            </div>
            ...
            <div class="attr-detail attr-size mb-30">
                ...
                <ul class="list-filter size-filter font-small">
                    <li><a href="#" value="" id="dsize"> {{$product->product_size}}</a></li>
        ...
        <div class="attr-detail attr-size mb-30">
            ...
            <select class="form-control unicase-form-control" id="dcolor">
                ...
                @foreach ($product_colors as $size)
...
<ul class="mr-50 float-start">
    ...
    <li class="mb-5">Categoty:<span class="text-brand"> {{$product['cat']['category_name']}}</span></li>
    <li>Subcategory: <span class="text-brand">{{$product['subcategoty']['subcategory_name']}}</span></li>
</ul>
<ul class="float-start">
    ...
    <li>Stock:<span class="in-stock text-brand ml-5"> ( {{$product->product_qty}} ) </span> Items In Stock </li>
</ul>
</div>
        </div>
        <!-- Detail Info -->
            ...
            <div class="tab-pane fade" id="Vendor-info">
                <div class="vendor-logo d-flex mb-30">
                    ...
                    <div class="vendor-name ml-15">
                        ...
                        @if($product->vendor_id == NULL)
                        <h6>
                            <a href="{{ route('vendor.details',$product->id) }}">Owner</a>
                        </h6>
                        @else
                        <h6>
                            <a href="{{ route('vendor.details',$product->id) }}">{{ $product->vendor->name }}</a>
                        </h6>                                            
                        @endif
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="comment-list">
                                ...
                                $review = App\Models\Review::where('product_id',$product->id)->latest()->limit(5)->get();
                                @endphp
                    ...
                    <div class="row mt-60">
                        ...
                        <div class="col-12">
                            <div class="row related-products">
                                @foreach($relatedPorduct as $product)
                                    ...
                                    <div class="product-cart-wrap hover-up">  
                                        <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-badges product-badges-position product-badges-mrg">
                                                ...
                                                @else 
                                                <span class="hot">{{ round($disscount)}} %</span>           
                                                @endif
                                            </div>
                                        </div>
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="rating-result" title="90%">
                                                ...
                                                <div class="product-price">
                                                    <span>{{$product->selling_price}} EGP</span>
                                                    
                                                </div>
                                                @else 
                                                <div class="product-price">
                                                    <span>{{$product->selling_price - $product->discount_price}} EGP</span>
                                                    <span class="old-price">{{$product->selling_price}} EGP</span>
                                                </div>
                                                @endif
