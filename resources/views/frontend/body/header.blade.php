                            ...
                            @auth       
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('UserDashboard')}}"><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                                        </li>
                                        <li>
                                            <a href="{{route('UserDashboard')}}"><i class="fi fi-rs-label mr-10"></i>My Voucher</a>
                                        </li>
                                        <li>
                                            <a href="{{route('UserDashboard')}}"><i class="fi fi-rs-heart mr-10"></i>My Wishlist</a>
                                        </li>
                                        <li>
                                            <a href="{{route('UserDashboard')}}"><i class="fi fi-rs-settings-sliders mr-10"></i>Setting</a>
                                        </li>
                                        <li>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="inb"><img src="{{asset('frontend/assets/imgs/theme/logo.svg')}}" alt="logo" /></a>
                </div>
                        ...
                        <nav>
                            ...
                            @foreach($category as $item)
                                <li>
                                 ...
                                 @php
                                      $subcategory = App\Models\SubCategory::where('category_id', $item->id)->get();
                                 @endphp   
                                    <ul class="sub-menu">
                                        @foreach($subcategory as $items)
                                        <li><a href="{{ url('product/subcategory/'.$items->id.'/'.$items->subcategory_slug) }}" >{{$items->subcategory_name }}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                                @endforeach
                ...
                <div class="hotline d-none d-lg-flex">
                    ...
                    <p> {{$setting->support_phone}} <span> Support Center</span></p>
                </div>
