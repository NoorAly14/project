                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <!-- MAIN SLIDES -->
                            <img src="" alt="product image" id="piamge" />
                               ...
                               <br>
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        ...
                                        <span class="current-price text-brand" > LE  </span>
                                        
                                        <span>
                                            
                                            <span class="old-price font-md ml-15" id="oldprice">LE</span>
                                ...
                                <div class="col-md-6">
                                    <div class="font-xs">
                                        <ul>
                                            ...
                                            <li class="mb-5">Vendor:<span class="text-brand"  id="pvendor"> </span></li>
                                        </ul>
                                    </div>                 
                                </div> <!-- // End col  -->
