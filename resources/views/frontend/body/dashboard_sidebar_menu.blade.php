...
<div class="col-md-3">
    ...
    <ul class="nav flex-column" role="tablist">
        <li class="nav-item">
            <a class="nav-link {{ ($route == 'UserDashboard')? 'active': '' }} "  href="{{ route('UserDashboard') }}" ><i class="fi-rs-settings-sliders mr-10"></i>Dashboard</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ ($route == 'user.order.page')? 'active': '' }}" href="{{ route('user.order.page') }}" ><i class="fi-rs-shopping-bag mr-10"></i>Orders</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ ($route == 'return.order.page')? 'active': '' }}" href="{{ route('return.order.page') }}" ><i class="fi-rs-shopping-bag mr-10"></i>Retrun Orders</a>
        </li>
        <li class="nav-item">
