        ...
        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="product-price">
                                        <span>{{$item->selling_price}} LE</span>
                                        
                                    </div>
                                    @else 
                                    <div class="product-price">
                                        <span>{{$item->selling_price - $item->discount_price}} LE</span>
                                        <span class="old-price">{{$item->selling_price}} LE</span>
                                    </div>
                                    @endif
                                    <div class="add-cart">
            ...
            <div class="tab-pane fade" id="category{{ $category->id }}" role="tabpanel" aria-labelledby="tab-two">
                <div class="row product-grid-4">
                   ...
                   @php
                       $catProduct = App\Models\Product::where('category_id', $category->id)->get();
                   @endphp

                   @forelse($catProduct as $item)
                   <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                     <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            ...
                            <div class="product-action-1">
                                <a aria-label="Add To Wishlist" class="action-btn" id="{{ $item->id }}" onclick="addToWishList(this.id)" ><i class="fi-rs-heart"></i></a>
                                <a aria-label="Compare" class="action-btn" href="bl"><i class="fi-rs-shuffle"></i></a>
                                <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $item->id }}" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-content-wrap">
                            ...
                            <span class="font-small ml-5 text-muted"> asdfadsfadsfdasf</span>
                        </div>
                            <div>
                                @if ($item->vendor_id == NULL)
                                <span class="font-small text-muted">By <a href="vendor-details-1.html">Onwer</a></span>
