                        ...
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="{{ route('vendor.details',$item->id) }}">
                                    <img class="default-img" src="{{ (!empty($item->photo)) ? url('upload/vendor_images/'.$item->photo) : url('upload/no_image.jpg')  }}" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="vendor-content-wrap">
                            <div class="d-flex justify-content-between align-items-end mb-30">
                                ...
                                $products = App\Models\Product::where('vendor_id',$item->id)->get();
                                             @endphp 
                                <div class="mb-10">
                                    <span class="font-small total-product">{{count($products)}} Product</span>
                                </div>
                            </div>
                            <div class="vendor-info mb-30">
                                <ul class="contact-infor text-muted">
                                    <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address : </strong> <span>{{$item->address}}</span></li>
