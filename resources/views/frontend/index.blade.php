...
@endsection
    ...
    @include('frontend.home.home_features_product')  
        ...
        <section class="product-tabs section-padding position-relative">
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    <h3>{{$skip_cat->category_name}} Category </h3>
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div>
                                            ...
                                            <span class="font-small text-muted">By <a href="{{ route('vendor.details',$item->id) }}">Onwer</a></span>
                                            @else
        ...
        <section class="product-tabs section-padding position-relative">
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    <h3>{{$skip_cat_1->category_name}} Category </h3>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div>
                                            @if ($item->vendor_id == NULL)
                                            <span class="font-small text-muted">By <a href="vendor-details-1.html">Onwer</a></span>
                                            @else
        ...
        <section class="product-tabs section-padding position-relative">
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    <h3>{{$skip_cat_2->category_name}} Category </h3>
                        ...
                        <div class="product-list-small animated animated">
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{ asset($product->product_thambnail) }}" alt="" /></a>
                                </figure>
