                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="vendor_join" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="vendor_short_info" class="form-control" id="inputAddress2" placeholder="{{$vendordata->vendor_short_info}}" rows="3"
                                        >{{$vendordata->vendor_short_info}}</textarea>
                                </div>
                            </div>
                                    <!-- photo -->
                            <div class="row mb-3">
