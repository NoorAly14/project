...
<div class="card">
    <div class="card-body p-4">
          ...
          <hr/>
        <form id="myForm" action="{{route('vendor.update.product')}}" method="POST" enctype="multipart/form-data">
            @csrf
           ...
           <div class="form-body mt-4">
            <div class="row">
               ...
               <div class="border border-3 p-4 rounded">
                ...
                <textarea class="form-control" name="short_descp" id="inputProductDescription" rows="3">{{$product->short_descp}}
                </textarea>
                </div>

                <div class="mb-3">
                    <label for="inputProductDescription" class="form-label">Long Description</label>
                    <textarea id="mytextarea" name="long_descp">{{$product->long_descp}}
                    </textarea>
                </div>
                  ...
                  <div class="row g-3">
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="product_code" id="inputCostPerPrice" value="{{$product->product_code}}">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputStarPoints" class="form-label">Product Quantity</label>
                        <input type="text" class="form-control" name="product_qty" id="inputStarPoints" value="{{$product->product_qty}}">
                      </div>
                      ...
                      <div class="form-group col-12">
                        ...
                        <select name="subcategory_id" class="form-select" id="inputCollection">
                            ...
                            <option value="{{$subcategorys->id}}" {{ $subcategorys->id == $product->subcategory_id ? 'selected' : ' '}} >{{$subcategorys->subcategory_name}}</option>
                            @endforeach
                          </select>
                      </div>
                      ...
                      <div class="col-12">
                          <div class="d-grid">
                            <input type="submit" class="btn btn-primary px-4" value="Save Changes" />
                             ...
                             <!-- Image Thambnail  //////// -->
<div class="page-content">
    <h6 class="mb-0 text-uppercase">Update Mani Image Thambnail </h6>
    <hr>
    <div class="card">
     <form action="{{route('vendor.update.product.thambnail')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group mb-3">
                <label for="formFile" class="form-label">Chose Image Thambnail </label>
            ...
            <input type="submit" class="btn btn-primary px-4" value="Save Changes" />
                            ...
                            <!-- End  Image Thambnail  //////// -->
                             ...
                             <!-- Mlti Image Image  //////// -->
<div class="page-content">
  <h6 class="mb-0 text-uppercase">Update Mlti Image </h6>
  <hr>
    <div class="card">
    <div class="card-body">
            ...
            <thead>
                ...
                <tbody>
                    <form action="{{route('vendor.update.product.multiimage')}}" method="POST" enctype="multipart/form-data">
                        @csrf
               @foreach($Mult_iamge as $key => $images)         
                    <tr>
                        <th scope="row"> {{$key+1}} </th>
                        <td> <img src="{{asset( $images->photo_name )}}" style="width: 70px; height:40px;" ></td>
                        <td> <input type="file" class="form=group" name="multi_img[ {{$images->id}} ]"> </td>                                                              
                        <td> 
                            <input type="submit" class="btn btn-primary px-4" value="Update Image" />
                            <a href=" {{ route('vendor.product.multiimage.delete',$images->id)}}"  id="delete" class="btn btn-danger" >Delete</a>
                        </td>
                    </tr>
                @endforeach    
                </form> 
